...
<div class="container mt-3">
  ...
  <form action="" method="post">
    ...
    <div class="mb-3">
      <label for="namatipe">Nomor Penyewa:</label>
      <input type="text" class="form-control" id="nomorpenyewa" placeholder="Masukan Nomor" name="nomorpenyewa">
    </div>
  ...
  if (isset($_POST['bSimpan'])) {
	  ...
	  $nomorpenyewa=$_POST['nomorpenyewa'];
  
    $sql="insert into `tabelpenyewa` (namapenyewa,nomorpenyewa) values ('".$namapenyewa."','".$nomorpenyewa."')";
